                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('tasks.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="due_date" type="date" class="form-control @error('due_date') is-invalid @enderror" name="due_date" value="{{ old('due_date') }}" autocomplete="due_date" min="<?= $currentDate ?>">
